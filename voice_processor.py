...
2. Если пользователь говорит "завтра", "послезавтра", "через 3 дня" — вычисли правильную дату относительно текущей даты
3. Если указана относительная дата (например, "в пятницу"), вычисли дату относительно текущей недели
4. Если дедлайн не указан, оставь поле null
5. Если ответственные не указаны, оставь массив пустым
...
- "Поручить Ивану и Марии провести анализ конкурентов до 15 марта" -> {{"title": "Провести анализ конкурентов", "description": null, "responsibles": ["Иван", "Мария"], "deadline": "2025-03-15", "priority": "medium", "confidence": 0.8}}
- "Сегодня срочно исправить ошибку на сайте ответственный Петр" -> {{"title": "Исправить ошибку на сайте", "description": null, "responsibles": ["Петр"], "deadline": "{current_date_only}", "priority": "high", "confidence": 0.9}}
